...
module Alchemy
  describe Admin::ElementsController do
    ...
    context "as unauthorized user" do
      ...
      describe "#create" do
        it "redirects to login page" do
          post :create, params: {element: {name: "news", page_version_id: page_version.id}}
          expect(response).to redirect_to("/login")
        end
      end
      ...
      describe "#update" do
        it "redirects to login page" do
          put :update, params: {id: element.id, element: {tag_list: "Tag 1"}}
          expect(response).to redirect_to("/login")
        end
      end
      ...
      describe "#destroy" do
        it "redirects to login page" do
          delete :destroy, params: {id: element.id}
          expect(response).to redirect_to("/login")
        end
      end
      ...
      describe "#publish" do
        it "redirects to login page" do
          post :publish, params: {id: element.id}
          expect(response).to redirect_to("/login")
        end
      end
      ...
      describe "#order" do
        it "redirects to login page" do
          post :order, params: {element_id: element.id}
          expect(response).to redirect_to("/login")
        end
      end
      ...
      describe "#collapse" do
        it "redirects to login page" do
          post :collapse, params: {id: element.id}
          expect(response).to redirect_to("/login")
        end
      end
      ...
      describe "#collapse" do
        it "redirects to login page" do
          post :expand, params: {id: element.id}
          expect(response).to redirect_to("/login")
        end
      end
    end
