  ...
  describe PagesHelper do
    ...
    describe "#page_title" do
      ...
      context "when current page has a title set" do
        before { public_page.public_version.update!(title: "My Public Page") }
      ...
      context "when current page has no title set" do
        before do
          language_root.draft_version.update!(title: "Title from language root")
        end
    ...
    describe "meta data" do
      ...
      describe "#meta_description" do
        ...
        context "when current page has a meta description set" do
          before { public_page.public_version.update!(meta_description: "description of my public page") }
          it { is_expected.to eq "description of my public page" }
        end

        context "when current page has no meta description set" do
          before do
            language_root.draft_version.update!(meta_description: "description from language root")
            allow(Language).to receive_messages(current_root_page: language_root)
          end

          context "when #meta_description is an empty string" do
            before { public_page.public_version.update!(meta_description: "") }
          ...
          context "when #meta_description is nil" do
            before { public_page.public_version.update!(meta_description: nil) }
