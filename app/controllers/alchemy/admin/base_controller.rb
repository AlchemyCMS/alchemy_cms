...
module Alchemy
  module Admin
    ...
    class BaseController < Alchemy::BaseController
      ...
      # Controllers of the host application can inherit from this class, and
      # their views would not be ours to make assumptions about.
      def apply_content_security_policy? = controller_path.start_with?("alchemy/")
