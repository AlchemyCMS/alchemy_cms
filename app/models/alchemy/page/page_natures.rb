...
module Alchemy
  class Page < BaseRecord
    module PageNatures
      ...
      # CacheControl of every published element on the page whose definition
      # declares a non-default `page_cache`. Only touches the database when at
      # least one element definition is non-default.
