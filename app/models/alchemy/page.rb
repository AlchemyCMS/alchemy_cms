...
module Alchemy
  class Page < BaseRecord
    ...
    stampable stamper_class_name: Alchemy.config.auth.user_class_name

    belongs_to :language

    belongs_to :creator,
      primary_key: Alchemy.config.auth.user_class_primary_key,
      class_name: Alchemy.config.auth.user_class_name,
