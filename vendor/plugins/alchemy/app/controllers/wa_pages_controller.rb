class WaPagesController < ApplicationController
  ...
  def edit_content
    ...
    @created_by = WaUser.find(@wa_page.created_by).login rescue ""
    @updated_by = WaUser.find(@wa_page.updated_by).login rescue ""
