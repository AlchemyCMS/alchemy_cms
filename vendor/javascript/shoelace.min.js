 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
function Ht(t,e){return(e,o,i)=>((t,e,o)=>(o.configurable=!0,o.enumerable=!0,Reflect.decorate&&"object"!=typeof e&&Object.defineProperty(t,e,o),o))(e,o,{get(){return(e=>e.renderRoot?.querySelector(t)??null)(this)}})}var It=class extends $t{constructor(){super(),Object.entries(this.constructor.dependencies).forEach((([t,e])=>{this.constructor.define(t,e)}))}emit(t,e){const o=new CustomEvent(t,c({bubbles:!0,cancelable:!1,composed:!0,detail:{}},e));return this.dispatchEvent(o),o}static define(t,e=this,o={}){const i=customElements.get(t);if(!i){try{customElements.define(t,e,o)}catch(i){customElements.define(t,class extends e{},o)}return}let s=" (unknown version)",r=s;"version"in e&&e.version&&(s=" v"+e.version),"version"in i&&i.version&&(r=" v"+i.version),s&&r&&s===r||console.warn(`Attempted to register <${t}>${s}, but <${t}>${r} has already been registered.`)}};It.version="2.16.0",It.dependencies={},d([Nt()],It.prototype,"dir",2),d([Nt()],It.prototype,"lang",2);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Vt=1,Wt=3,jt=4,qt=t=>(...e)=>({_$litDirective$:t,values:e});let Kt=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,o){this._$Ct=t,this._$AM=e,this._$Ci=o}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Zt=qt(class extends Kt{constructor(t){if(super(t),t.type!==Vt||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((e=>t[e])).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const o=t.element.classList;for(const t of this.st)t in e||(o.remove(t),this.st.delete(t));for(const t in e){const i=!!e[t];i===this.st.has(t)||this.nt?.has(t)||(i?(o.add(t),this.st.add(t)):(o.remove(t),this.st.delete(t)))}return at}}),Gt=t=>t??lt
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */,Xt={},Yt=qt(class extends Kt{constructor(t){if(super(t),t.type!==Wt&&t.type!==Vt&&t.type!==jt)throw Error("The `live` directive is not allowed on child or event bindings");if(!(t=>void 0===t.strings)(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===at||e===lt)return e;const o=t.element,i=t.name;if(t.type===Wt){if(e===o[i])return at}else if(t.type===jt){if(!!e===o.hasAttribute(i))return at}else if(t.type===Vt&&o.getAttribute(i)===e+"")return at;return((t,e=Xt)=>{t._$AH=e;
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,de=Symbol(),pe=Symbol(),ue=new Map,fe=class extends It{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(t,e){var o;let i;if(null==e?void 0:e.spriteSheet){this.svg=nt`<svg part="svg">
...
`,Ie=0,Ve=class extends It{constructor(){super(...arguments),this.attrId=++Ie,this.componentId=`sl-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return nt`
      <slot
        part="base"
        class=${Zt({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}};Ve.styles=[Dt,He],d([Nt({reflect:!0})],Ve.prototype,"name",2),d([Nt({type:Boolean,reflect:!0})],Ve.prototype,"active",2),d([Rt("active")],Ve.prototype,"handleActiveChange",1),Ve.define("sl-tab-panel");var We=k`
  :host {
    --max-width: 20rem;
    --hide-delay: 0ms;
    --show-delay: 150ms;
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */;const ci="important",hi=" !"+ci,di=qt(class extends Kt{constructor(t){if(super(t),t.type!==Vt||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce(((e,o)=>{const i=t[o];return null==i?e:e+`${o=o.includes("-")?o:o.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`}),"")}update(t,[e]){const{style:o}=t.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(e)),this.render(e);for(const t of this.ft)null==e[t]&&(this.ft.delete(t),t.includes("-")?o.removeProperty(t):o[t]=null);for(const t in e){const i=e[t];if(null!=i){this.ft.add(t);const e="string"==typeof i&&i.endsWith(hi);t.includes("-")||e?o.setProperty(t,e?i.slice(0,-11):i,e?ci:""):o[t]=i}}return at}});var pi=class extends It{constructor(){super(...arguments),this.localize=new Le(this),this.value=0,this.indeterminate=!1,this.label=""}render(){return nt`
      <div
        part="base"
