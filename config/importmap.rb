...
pin "flatpickr", to: "flatpickr.esm.js", preload: true # @4.6.13
pin "sortablejs", to: "sortable.esm.js", preload: true # @1.15.1
pin "@hotwired/turbo-rails", to: "turbo.min.js", preload: true
pin "shoelace", to: "shoelace.esm.js", preload: true
pin "@rails/ujs", to: "rails-ujs.esm.js", preload: true # @7.1.2
