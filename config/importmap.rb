...
pin "@shoelace/alert", to: "https://cdn.jsdelivr.net/npm/@shoelace-style/shoelace@2.9.0/cdn/components/alert/alert.js", preload: true
pin "@shoelace/icon-library", to: "https://cdn.jsdelivr.net/npm/@shoelace-style/shoelace@2.9.0/cdn/utilities/icon-library.js", preload: true
