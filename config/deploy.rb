...
namespace :alchemy do
  ...
  task :release do
    system('svn remove -m "removing for new release" http://svn.vondeyen.com/alchemy/releases/v1.1.1')
    system('svn copy -m "new release" http://svn.vondeyen.com/alchemy/trunk http://svn.vondeyen.com/alchemy/releases/v1.1.1')
  end
