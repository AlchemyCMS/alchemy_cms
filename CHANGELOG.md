...
## What's Changed
### Other Changes
* [8.2-stable] fix(LocaleSelect): Use request.path instead of helpers.url_for by @alchemycms-bot[bot] in https://github.com/AlchemyCMS/alchemy_cms/pull/3998


**Full Changelog**: https://github.com/AlchemyCMS/alchemy_cms/compare/v8.2.6...v8.2.7
...
## What's Changed
### Bug Fixes
* [8.2-stable] fix(ElementEditor): Highlight publish button after saving fixed element by @alchemycms-ci-bot in https://github.com/AlchemyCMS/alchemy_cms/pull/3985
### Security
* [8.2-stable] fix(api): authorize nested pages endpoint against restricted content by @alchemycms-bot[bot] in https://github.com/AlchemyCMS/alchemy_cms/pull/3988
### Other Changes
...
* [8.2-stable] fix(layoutpage): Display page icon for not locked pages by @alchemycms-bot[bot] in https://github.com/AlchemyCMS/alchemy_cms/pull/3964
* [8.2-stable] fix(publication_fields): Update for flatpickr removal by @alchemycms-ci-bot in https://github.com/AlchemyCMS/alchemy_cms/pull/3968
* [8.2-stable] fix(TemplateTracker): Remove ingredient views by @alchemycms-bot[bot] in https://github.com/AlchemyCMS/alchemy_cms/pull/3967
* [8.2-stable] fix(TimezoneSelect): Use request path over url helper by @alchemycms-bot[bot] in https://github.com/AlchemyCMS/alchemy_cms/pull/3976
...
## What's Changed
### Other Changes
* [8.2-stable] Fix Attachment#deletable? false positives by @alchemycms-bot[bot] in https://github.com/AlchemyCMS/alchemy_cms/pull/3859


**Full Changelog**: https://github.com/AlchemyCMS/alchemy_cms/compare/v8.2.2...v8.2.3
...
* Use select2 for time zone select by @tvdeyen in https://github.com/AlchemyCMS/alchemy_cms/pull/3808
* Preview time select by @tvdeyen in https://github.com/AlchemyCMS/alchemy_cms/pull/3789
* Add allow_clear support and required attribute to SelectEditor by @dbwinger in https://github.com/AlchemyCMS/alchemy_cms/pull/3824
### Bug Fixes
...
* Fix delete page in page tree by @kulturbande in https://github.com/AlchemyCMS/alchemy_cms/pull/3814
...
* chore(deps-dev): bump vitest from 4.1.1 to 4.1.2 by @dependabot[bot] in https://github.com/AlchemyCMS/alchemy_cms/pull/3796
* chore(deps): bump handlebars from 4.7.8 to 4.7.9 by @dependabot[bot] in https://github.com/AlchemyCMS/alchemy_cms/pull/3797
* chore(deps): bump tinymce from 8.3.2 to 8.4.0 by @dependabot[bot] in https://github.com/AlchemyCMS/alchemy_cms/pull/3810
* chore(deps-dev): bump eslint from 10.1.0 to 10.2.0 by @dependabot[bot] in https://github.com/AlchemyCMS/alchemy_cms/pull/3812
* chore(deps-dev): bump sass from 1.98.0 to 1.99.0 by @dependabot[bot] in https://github.com/AlchemyCMS/alchemy_cms/pull/3813
* chore(deps-dev): bump rollup from 4.60.0 to 4.60.1 in the rollup group across 1 directory by @dependabot[bot] in https://github.com/AlchemyCMS/alchemy_cms/pull/3809
* chore(deps-dev): bump vitest from 4.1.2 to 4.1.3 by @dependabot[bot] in https://github.com/AlchemyCMS/alchemy_cms/pull/3819
* chore(deps-dev): bump jsdom from 29.0.1 to 29.0.2 by @dependabot[bot] in https://github.com/AlchemyCMS/alchemy_cms/pull/3818
### Other Changes
...
* Prevent deletion of pages with descendants that are attached to nodes by @kulturbande in https://github.com/AlchemyCMS/alchemy_cms/pull/3815

## New Contributors
* @phylor made their first contribution in https://github.com/AlchemyCMS/alchemy_cms/pull/3733
* @halfbyte made their first contribution in https://github.com/AlchemyCMS/alchemy_cms/pull/3790

**Full Changelog**: https://github.com/AlchemyCMS/alchemy_cms/compare/v8.1.9...v8.2.0
