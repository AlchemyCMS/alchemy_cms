class AddPublicationTimestampsToAlchemyElements < ActiveRecord::Migration[7.1]
  def up
    ...
    remove_column :alchemy_elements, :public
  end

  def down
    add_column :alchemy_elements, :public, :boolean, default: true
