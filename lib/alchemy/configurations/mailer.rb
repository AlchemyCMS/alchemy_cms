...
module Alchemy
  module Configurations
    class Mailer < Alchemy::Configuration
      ...
      option :fields, :collection, item_class: String, default: %w[salutation firstname lastname address zip city phone email message]
      option :validate_fields, :collection, item_class: String, default: %w[lastname email]
    end
  end
end
