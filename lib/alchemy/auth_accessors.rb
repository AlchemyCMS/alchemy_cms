...
module Alchemy
  class << self
    ...
    deprecate user_class: "Use `Alchemy.config.auth.user_class instead", deprecator: Alchemy::Deprecation
    def user_class_name
      config.auth.user_class_name
    end
    deprecate user_class_name: "Use `Alchemy.config.auth.user_class_name instead", deprecator: Alchemy::Deprecation
